// From https://github.com/jamesshore/automatopia/blob/master/build/util/version_checker.js
(function() {
	"use strict";
	...
	exports.check = function(options, success, fail) {
		if (options.strict) {
			...
			if (semver.neq(options.actual, options.expected)) {
				console.log(
					"Warning: Newer " + options.name + " version than expected. " +
					"Expected " + options.expected + ", but was " + options.actual + "."
				);
			}
		}
		return success();
